...
public class YPotScript : MonoBehaviour {
        ...
        switch (num)
        {
            case 1:
                if (recepiesValues[0] == true)
                {
                    ...
                    Player.GetComponent<Movement>().grasshoppers -= 3;
                }
                else
                {
                    KeyEvent(2);
            ...
            case 2:
                if (recepiesValues[1] == true)
                {
                    ...
                    Player.GetComponent<Movement>().flies -= 2;
    ...
    void RecipeDraw()
    {
        if (Player.GetComponent<Movement>().grasshoppers >= 3)
        {
            rec1 = true;
        }
        else { rec1 = false; }
        if (Player.GetComponent<Movement>().flies >= 2 && Player.GetComponent<Movement>().grasshoppers >= 1)
        {
            rec2 = true;
        }
        else { rec2 = false; }
        if (Player.GetComponent<Movement>().butterflies >= 1 && Player.GetComponent<Movement>().dragonflies >= 1 && Player.GetComponent<Movement>().flies >= 1)
        {
            rec3 = true;
        }
        else { rec3 = false; }
        ...
        if (Player.GetComponent<Movement>().carterpilars >= 2 && Player.GetComponent<Movement>().frogs >= 1)
        {
            rec5 = true;
        }
        else { rec5 = false; }
