...
public class GPotScript : MonoBehaviour {
        ...
        switch (num)
        {
            ...
            case 2:
                if (recepiesValues[1] == true)
                {
                    ...
                    Player.GetComponent<Movement>().frogs -= 3;
                }
                else
                {
                    KeyEvent(3);
            ...
            case 4:
                if (recepiesValues[3] == true)
                {
                    ...
                    Player.GetComponent<Movement>().flies -= 1;
                    Player.GetComponent<Movement>().dragonflies -= 2;
                }
                else
                {
                    KeyEvent(5);
            ...
            case 6:
                if (recepiesValues[5] == true)
                {
                    ...
                    Player.GetComponent<Movement>().bees -= 1;
                    Player.GetComponent<Movement>().carterpilars -= 1;
                    Player.GetComponent<Movement>().butterflies -= 1;
                }
                else
                {
                    KeyEvent(7);
    ...
    void RecipeDraw()
    {
        if (Player.GetComponent<Movement>().flies >= 1 && Player.GetComponent<Movement>().bees >= 1 && Player.GetComponent<Movement>().carterpilars >= 1)
        {
            rec1 = true;
        }
        else { rec1 = false; }
        if (Player.GetComponent<Movement>().frogs >= 3)
        {
            rec2 = true;
        }
        else { rec2 = false; }
        ...
        if (Player.GetComponent<Movement>().dragonflies >= 2 && Player.GetComponent<Movement>().flies >= 1)
        {
            rec4 = true;
        }
        else { rec4 = false; }
        if (Player.GetComponent<Movement>().frogs >= 1 && Player.GetComponent<Movement>().grasshoppers >= 1 && Player.GetComponent<Movement>().worms >= 1)
        {
            rec5 = true;
        }
        else { rec5 = false; }
        if (Player.GetComponent<Movement>().bees >= 1 && Player.GetComponent<Movement>().carterpilars >= 1 && Player.GetComponent<Movement>().butterflies >= 1)
        {
            rec6 = true;
        }
        else { rec6 = false; }
